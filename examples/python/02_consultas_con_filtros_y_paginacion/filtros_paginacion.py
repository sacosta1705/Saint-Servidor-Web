...
def consultar_clientes():
    ...
    filtros = 'saldo>2000'
    limite = 5
    endpoint = f'{API_URL}/adm/customers?{filtros}&limit={limite}'
    ...
    try:
        ...
        for cliente in clientes:
            print(f'Codigo: {cliente.get("codclie")} | Nombre: {cliente.get("descrip")} | Saldo: {cliente.get("saldo")}')
    except requests.exceptions.RequestException as e:
        return f'fallo en la consulta {e}'
